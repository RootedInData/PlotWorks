...
save_agency_plot <- function(plot, file, preset = "single", width = NULL,
                             height = NULL, dpi = 300) {
  dims <- agency_export_presets[[preset]]
  if (is.null(dims)) dims <- agency_export_presets$single
